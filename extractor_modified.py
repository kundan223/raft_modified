...
class ResidualBlock1(nn.Module):
    def __init__(self, in_planes, planes, norm_fn='group', stride=1):
        ...
        self.conv2 = QuaternionConv(planes, planes, kernel_size=3, padding=1 , stride =stride)
        self.relu = Relu()
...
class BasicEncoder(nn.Module):
    def __init__(self, output_dim=128, norm_fn='batch', dropout=0.0):
        ...
        self.conv1 = QuaternionConv(4, 64, kernel_size=3, stride=1, padding=1)
        ...
        # output convolution
        self.conv2 = QuaternionConv(128, output_dim, kernel_size=1,stride=1)
